...
def run_analysis(image_path, diagnosis_label, silent_mode=False, n_clusters=3):
    try:
        ...
        if not silent_mode:
            ...
            plt.subplot(1, 2, 1); plt.imshow(img, cmap='gray'); plt.title("Original (Pre-processed CLAHE)")
            plt.subplot(1, 2, 2); plt.imshow(segmented_image, cmap='viridis'); plt.title("Segmentasi GMM")
            plt.show()
...
# ==========================================================
# GUI CONTROL (MULTIPLE FILE SUPPORT)
# ==========================================================
...
if __name__ == "__main__":
    ...
    status_label = ttk.Label(main_frame, text="Siap menerima input...", foreground="gray")
